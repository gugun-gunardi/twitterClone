...
const Sidebar = () => {
  ...
  return (
    <div className=' hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
      ...
      <button className='hidden xl:inline ml-auto bg-[#1d9bf0] text-white rounded-full w-56 h-[52px] text-lg font-bold shadow-md hover:bg-[#1a8cd8] transition duration-300 focus:ring focus:outline-none'>
        Tweet
      </button>
      <div
